...
const Sidebar = () => {
  ...
  const handleBackground = (e) => {
    ...
    currentLink.style.background = "#f8c36e";
  ...
  return (
    ...
    <div id="sidebar" >
      <header>
       <Link to="/Home" className="link_logo"><img src={require("../assets/logo-no-background.png")} alt="logo" className="logo img-fluid"/></Link>
      </header>
      <div className="nav">
        <li>
